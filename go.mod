...
require (
	...
	github.com/mattermost/focalboard/server v0.0.0-20220718180559-e1c747d08b01
	github.com/mattermost/logr/v2 v2.0.15
	github.com/mattermost/mattermost-server/v6 v6.0.0-20220718154632-01fce41bd77a
)
